...
public class PostProcessing {
    ...
    public void setup(float downSizeFactor, Scene sc){
        ...
        halfA = new FrameBuffer((int) (min/downSizeFactor)/4, (int) (min/downSizeFactor)/4,true, false,false,false);
        halfB = new FrameBuffer((int) (min/downSizeFactor)/4, (int) (min/downSizeFactor)/4,true, false, false,false);
        ...
        SSRColor = new FrameBuffer((int) (min/downSizeFactor/4), (int) (min/downSizeFactor/4),true, false, false,false);
